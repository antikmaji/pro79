...
export default class DailyPicScreen extends Component {
    ...
    renderImage = (url) => {
        ...
        // <Image source={ "uri": url }
        // style={{ width: "100%", height: 300,       xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
        //borderRadius: 20, margin: 3 }}>
        // </Image>
        
        // <Image source={{ "uri"= url }} 
        // style={{ width: "100%", height: 300,         xxxxxxxxxxxxxxxxxxxxxxxxxxxxx
        //borderRadius: 20, margin: 3 }}>
        // </Image>
        
        // <Image require={{ "uri": url }}                 xxxxxxxxxxxxxxxxxxxxxxxxxxx
        // style={{ width: "100%", height: 300, 
        //borderRadius: 20, margin: 3 }}>
        // </Image>
